...
import com.verush.brewery.domain.Beer;
import com.verush.brewery.repositories.BeerRepository;
import com.verush.brewery.web.mappers.BeerMapper;
import com.verush.brewery.web.model.BeerDto;
import com.verush.brewery.web.model.BeerPagedList;
...
public class BeerServiceImpl implements BeerService {
    ...
    public void updateBeer(UUID beerId, BeerDto beerDto) {
        ...
        beerOptional.orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Not Found. UUID: " + beerId));
        /*, () -> {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Not Found. UUID: " + beerId);
        });*/
    }
